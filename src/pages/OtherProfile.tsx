  ...
  return (
    <section>
      <div className="relative flex min-h-[calc(100vh-160px)] w-full flex-col items-center gap-4 bg-lightIvory p-4 pt-0 text-lightText dark:bg-darkNavy dark:text-white">
        <OtherProfileHeader userId={data?.userId as string} nickName={data?.nickName as string} profileUrl={data?.profileUrl as string} description={data?.description as string} />
        <OtherProfileInfo
