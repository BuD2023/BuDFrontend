...
export default function MyProfileEdit() {
  ...
  return (
    <section>
      <div className="mt-16 flex flex-col gap-7 p-4 text-white">
        ...
        <div className="mt-16 flex flex-col gap-7 p-4">
          ...
          <div className="mb-4 flex flex-col gap-4 text-xl font-bold">
            ...
            <input onChange={onChangeNickname} type="text" value="JHni2" className="h-[54px] w-full rounded-[20px] bg-lightNavy p-2 px-4 focus:outline-none"></input>
          </div>
