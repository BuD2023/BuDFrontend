  ...
  return (
    <section>
      <div className="mt-6 flex flex-col gap-4 p-4">
        ...
        <div className="flex justify-between gap-4 text-[22px] font-bold">
          <div className="flex h-[67px] w-full items-center justify-center bg-midNavy px-4">
            <p className="text-center leading-[26px]">&#127357; Naver news</p>
          </div>
          <div className="flex h-[67px] w-full items-center justify-center bg-[#383030] px-4">
        ...
        <ul>
          {dummyData.map((data) => (
            <li key={data.id} className="mb-4 flex h-[105px] items-center gap-1 rounded-[20px] bg-midNavy">
              <div className="shrink-0">
                <img src={data.img} alt={data.title} className="rounded-[20px]" />
              </div>
              <div className="w-full overflow-hidden pl-3 pr-5">
                <h1 className="mb-2 truncate text-base font-bold">{data.title}</h1>
                <p className="ellipsis mb-1 text-[13px]">{data.detail}</p>
