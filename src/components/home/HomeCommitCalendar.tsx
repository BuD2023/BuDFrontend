...
export default function HomeCommitCalendar({ commits, isLoading }: HomeCommitCalendarProps) {
  ...
  return (
    <div className="relative mb-2 flex min-h-[260px] w-full flex-col">
      <div className="absolute inset-0 flex flex-col justify-between gap-6 rounded-[50px] bg-midIvory p-10 text-lightText dark:bg-midNavy dark:bg-midNavy dark:text-white">
