      ...
      <ul className="flex flex-col text-xl">
        <li className="flex cursor-pointer py-2">
          ...
          <label onClick={handleTheme} htmlFor="light" className="flex grow cursor-pointer justify-between">
            <span>라이트 모드</span>
            {theme === themeLight ? <MdOutlineRadioButtonChecked color="#327559" size="22" /> : <MdOutlineRadioButtonUnchecked color="#d9d9d9" />}
          </label>
        </li>
        <li className="flex cursor-pointer py-2">
          ...
          <label onClick={handleTheme} htmlFor="dark" className="flex grow cursor-pointer justify-between">
            <span>다크 모드</span>
            {theme === themeDark ? <MdOutlineRadioButtonChecked color="#327559" size="22" /> : <MdOutlineRadioButtonUnchecked color="#d9d9d9" />}
          </label>
        </li>
      </ul>
    </div>
